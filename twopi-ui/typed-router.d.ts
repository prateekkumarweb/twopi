...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/app': RouteRecordInfo<'/app', '/app', Record<never, never>, Record<never, never>, '/app/finance/account' | '/app/finance/category' | '/app/finance/category.[id].detail' | '/app/finance/category.[id].edit' | '/app/finance/category.new' | '/app/finance/currency' | '/app/finance/currency.new' | '/app/finance/dashboard' | '/app/finance/import-export' | '/app/finance/transaction' | '/app/settings'>,
